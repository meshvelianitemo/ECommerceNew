...
export const TRANSLATIONS = {
  ...
  'product.addToCart':      { ka: '🛒 კალათაში',                     en: '🛒 Add to Cart' },
  'product.viewCart':       { ka: 'კალათაშია ✓',                     en: 'In Cart ✓' },
  ...
  /* ── Cart coming soon ── */
  'cart.title':             { ka: '🛒 კალათა',                       en: '🛒 Cart' },
  'cart.empty':             { ka: 'კალათა ცარიელია',                 en: 'Your cart is empty' },
  'cart.emptySub':          { ka: 'დაამატე პროდუქტები კალათაში',     en: 'Browse products and add them to your cart' },
  'cart.loginRequired':     { ka: 'კალათის გამოსაყენებლად შედი',    en: 'Please log in to use your cart' },
  'cart.added':             { ka: 'კალათაში დაემატა',                en: 'Added to cart' },
  'cart.removed':           { ka: 'კალათიდან ამოღებულია',            en: 'Removed from cart' },
  'cart.cleared':           { ka: 'კალათა გასუფთავდა',              en: 'Cart cleared' },
  'cart.subtotal':          { ka: 'სულ',                             en: 'Subtotal' },
  'cart.taxNote':           { ka: 'გადასახადი და მიწოდება — checkout-ზე', en: 'Taxes and shipping calculated at checkout' },
  'cart.checkout':          { ka: 'შეძენაზე გადასვლა →',             en: 'Proceed to Checkout →' },
  'cart.clearAll':          { ka: '🗑 კალათის გასუფთავება',          en: '🗑 Clear Cart' },
  'cart.qty':               { ka: 'რაოდ.',                           en: 'Qty' },
  'cart.count':             { ka: 'ნივთი',                           en: 'items' },
  'cart.addFailed':         { ka: 'კალათაში დამატება ვერ მოხერხდა', en: 'Failed to add to cart' },
  'cart.removeFailed':      { ka: 'კალათიდან ამოღება ვერ მოხერხდა', en: 'Failed to remove from cart' },
  'cart.viewFull':          { ka: 'კალათის ნახვა →',                 en: 'View Cart →' },
