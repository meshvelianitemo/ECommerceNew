...
public class ProductRepository : IProductRepository
{
    ...
    public async Task<PagedResult<ProductDetailDto>> ListAsync(ProductQueryParameters queryParams,bool isActive = true, CancellationToken cancellationToken = default)
    {
